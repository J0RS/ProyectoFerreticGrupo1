    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('categoria', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='ferretic.categoria')),
            ],
        ),
        migrations.CreateModel(
            name='Proveedor',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('punto_venta', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='ferretic.pos')),
            ],
        ),
        migrations.AddField(
            model_name='producto',
            name='proveedor',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='ferretic.proveedor'),
        ),
        migrations.CreateModel(
            name='Pedido',
            fields=[
